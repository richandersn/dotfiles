...
complete -c rcp -s D -d 'When using the SFTP protocol support via M, connect directly to a local SFTP …'
...
complete -c rcp -s O -d 'Use the legacy SCP protocol for file transfers instead of the SFTP protocol'
...
complete -c rcp -s s -d 'Use the SFTP protocol for file transfers instead of the legacy SCP protocol'
